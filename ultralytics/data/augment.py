    ...
    def __init__(self, p=1.0):
        ...
        try:
            ...
            T = [
                ...
                A.CropAndPad(percent=-0.2, p=1.0),
                A.CropAndPad(percent=0.2, p=1.0),
                ]  # transforms
            self.transform = A.Compose(T, bbox_params=A.BboxParams(format='yolo', label_fields=['class_labels', 'indices'], check_each_transform=True))
